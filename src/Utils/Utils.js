define(function (require) {
	...
	U.prototype = {
		...
		/* Define properties of object that will be immutable in ECMAScript 5 compliant browsers */
		defineConstant: function (object, name, value) {
			if(!_.isUndefined(object)) {

				try {
					if(Object && _.isFunction(Object.defineProperty)) {
		...
		replaceWithNumberInput: function ($elems) {
			$elems.each(function (iter, elem) {
				var newInput = elem.cloneNode(false);

				newInput.setAttribute('type', 'number');
				console.log(newInput, elem);
