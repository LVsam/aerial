define(function (require) {
	...
	function Poller(callback, interval, context) {
		if(!_.isFunction(callback)) {
			throw new ErrorInstance('InvalidArgumentException', 'Poller requires a callback function');
		}
	...
	Poller.prototype = {
		setInterval: function (interval) {
			if(!_.isNumber(interval)) {
				throw new ErrorInstance('InvalidArgumentException', 'Poller requires a numeric interval');
			}
